...
public class ProductControllerTest {
    ...
    private ProductDto prDto1 = ProductDto.builder().name("product1").price(11.22).build();
    private ProductDto prDto2 = ProductDto.builder().name("product2").price(22.33).build();
    ...
    public void updateTest() throws Exception {
        prDto1 = productService.save(prDto1);
        prDto1.setName("Product1(updated)");
