...
public class OrderControllerTest {
    ...
    public void init() {
        ...
        orderDto1 = OrderDto.builder()
                ...
                .checkoutDate(LocalDateTime.of(2020, 1, 1, 1, 1))
                .build();
    ...
    public void getItemsTest() throws Exception {
        ...
        ItemDto orderItemDto = ItemDto.builder().quantity(456).price(34.12).productId(productDto.getId()).build();
    ...
    public void addItemTest() throws Exception {
        ...
        ItemDto orderItemDto = ItemDto.builder()
                .quantity(456)
                .price(34.12)
